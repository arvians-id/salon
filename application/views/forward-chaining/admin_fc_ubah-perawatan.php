                            ...
                            <div class="card-body">
                                <form method="POST">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="<?= set_value('kode_jenis_perawatan', $getJenisPerawatan['kode_jenis_perawatan']) ?>" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label>Nama Jenis Perawatan</label><small class="text-danger"> *</small>
                                        <input type="text" name="nama_jenis_perawatan" class="form-control <?= form_error('nama_jenis_perawatan') ? 'is-invalid' : '' ?>" value="<?= set_value('nama_jenis_perawatan', $getJenisPerawatan['nama_jenis_perawatan']) ?>">
